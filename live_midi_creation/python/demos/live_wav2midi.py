...
data = ['./python/demos/wav2midi.py', './audio/audio_generation_test.wav', './midi/audio_generation.midi']
demo_pyaudio.live(data)
...
fs = FluidSynth()
fs.midi_to_audio('./midi/live_audio_generation.midi', './audio/output.wav')
